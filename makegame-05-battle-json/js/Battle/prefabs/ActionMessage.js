 ...
 */  
Airship.BattleState.ActionMessage = function (game_state, message_text, wait_time, message_color) {
    
    // font Style
    this._fontStyle = { font: "bold 16px Arial", boundsAlignH: "center"};
    this._fontStyle.fill = message_color || "white";
    
    // get the game state from the constructor
    this.game_state = game_state;

    // create message text
    this.game_state.message = this.game_state.add.text(400, 32, message_text, this._fontStyle);
